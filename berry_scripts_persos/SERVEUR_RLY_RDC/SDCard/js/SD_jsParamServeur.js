	...
	function paramFormulaire(jsonData, url) {
		...
		if (eb('categorie').value == "generale") {
			...
			if (jsonDetail == undefined) {
				if (document.querySelector("#fieldset_" + enteteID)) {
					document.querySelector("#fieldset_" + enteteID).style.display = "none";
					document.querySelector("#groupe_" + enteteID).style.display = "none";
				}
			} else {
				document.querySelector("#fieldset_" + enteteID).style.display = "block";
				document.querySelector("#groupe_" + enteteID).style.display = "block";
