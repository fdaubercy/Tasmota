<script type='application/javascript'>
	...
	var selectModule = (document.forms.selectParametres != undefined) ? document.forms.selectParametres.module : "";
	var selectCategorie = (document.forms.selectParametres != undefined) ? document.forms.selectParametres.categorie : "";
	...
	if (typeof paramFormulaire !== 'undefined') {
		window.addEventListener('load', (event) => {
			console.log('La page est complètement chargée !');
			httpRequest("/json" + window.location.search, 'GET', false, paramFormulaire);
		});
	} else {
		console.log('La variable \'paramFormulaire\' n\'est pas définie');
	}
</script>